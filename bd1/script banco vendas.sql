/* Base da Dados referente a disciplina de BDI II baseado no livro
de MACHADO, Felipe N. R., ABREU, Mauricio P., Projeto de Banco de Dados. 16 ed. Érica.
Exemplo do BD - pg. 218
*/
...
insert into cliente (codigo_cliente,nome_cliente,endereco,cidade,cep,uf,cnpj)values (110,'Jorge','Rua Caiapo 13','Curitiba','30078500','PR','14512764/9834-9');
...
insert into cliente (codigo_cliente,nome_cliente,endereco,cidade,uf,cnpj,ie) values (157,'Paulo','Tv Moraes c/3','Londrina','PR','32848223/324-2','1923');
insert into cliente (codigo_cliente,nome_cliente,endereco,cidade,cep,uf,cnpj) values (180,'Lívio','Av. Beira Mar n. 1256','Florianópolis','30077500','SC','12736571/2347-4');
insert into cliente values (260,'Susana','Rua Lopes Mendes n. 12','Niterói','30046500','RJ','21763571/232-9','2530');
insert into cliente values (290,'Renato','Rua Meireles n. 123 bl.2 sl.345','São Paulo','30225900','SP','13276571/1231-4','1820');
...
insert into item_pedido values (105,78,10);
insert into item_pedido values (111,25,10);
insert into item_pedido values (111,78,70);
insert into item_pedido values (103,53,37);
insert into item_pedido values (91,77,40);
insert into item_pedido values (138,22,10);
insert into item_pedido values (138,77,35);
insert into item_pedido values (138,53,18);
insert into item_pedido values (108,13,17);
insert into item_pedido values (119,77,40);
insert into item_pedido values (119,13,6);
insert into item_pedido values (119,22,10);
insert into item_pedido values (119,53,43);
insert into item_pedido values (137,13,8);
